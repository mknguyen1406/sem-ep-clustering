package org.streampipes.examples.jvm.processor.birch.net.sourceforge.sizeof;
...
public class SizeOf
{
	...
	{
		 if (c==Boolean.TYPE) return true;

		 if (c==Character.TYPE) return true;

		 if (c==Byte.TYPE) return true;

		 if (c==Short.TYPE) return true;

		 if (c==Integer.TYPE) return true;

		 if (c==Long.TYPE) return true;

		 if (c==Float.TYPE) return true;

		 if (c==Double.TYPE) return true;

		 if (c==Void.TYPE) return true;
